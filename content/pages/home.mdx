...
blocks:
  - hero_title: |
    ...
    links:
      ...
      - link: >-
          https://www.eventbrite.ca/e/omar-for-mayor-fundraiser-dinner-at-sahara-tickets-1351918096419?aff=oddtdtcreator
        label: May 29th Fundraiser Dinner
        button_type: primary
    backgroundImage: /media/omar-hero-back.png
    _template: welcomeHero
  - content: >
      # A Letter to Edmonton
      ...
      of talent, heart, and ambition—and that spirit is what I believe in and
      ...
      Northern Manitoba, shares a similar story: roots that span continents but
      a heart firmly planted in Edmonton. Our family, like so many here, thrives
      in this incredible city built on cultural diversity and shared values.
      ...
      Edmonton. These experiences—local and global—have taught me what works and
      what doesn't. They've also shown me that Edmonton's issues, while complex,
      ...
      problems—they're human problems. And they require action, not endless
      debate.
      ...
      economy. It's creating barriers where there should be solutions.


      We know better. And now is the time to do better.
